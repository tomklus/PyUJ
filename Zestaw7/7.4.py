...
class TestTriangle(unittest.TestCase):
    ...
    def test_make4(self):
        self.assertTrue(Triangle(0, 0, 0, 2, 1, 2).make4()[0].area() < Triangle(0,0,0,2,1,2).area())
        self.assertTrue(Triangle(0, 0, 0, 2, 1, 2).make4()[1].area() < Triangle(0, 0, 0, 2, 1, 2).area())
        self.assertTrue(Triangle(0, 0, 0, 2, 1, 2).make4()[2].area() < Triangle(0, 0, 0, 2, 1, 2).area())
        self.assertTrue(Triangle(0, 0, 0, 2, 1, 2).make4()[3].area() < Triangle(0, 0, 0, 2, 1, 2).area())
